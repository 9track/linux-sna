...
Tn5250Host *tn5250_host_new(Tn5250Stream *This)
{
  ...
  Tn5250Host *newHost = g_new(Tn5250Host, 1);
...
"                       (Press an AID key to disconnect)                        "
 ...
 for(currow = 0; currow < 16; currow++) 
   { 
     ...
     appendBlock2Ebcdic(&This->buffer, (unsigned char *)ascii_banner[currow], 
 ...
 appendBlock2Ebcdic(&This->buffer, (unsigned char *)"Test", 4, This->map);
 sendWrite(This);
