...
int cpicall(unsigned char CM_PTR conversation_id,
	unsigned short opcode, cpic_args *args, CM_RETURN_CODE CM_PTR return_code)
{
	if (cpic_sock == 0)
		cpic_sock = socket(PF_SNA, SOCK_DGRAM, SNAPROTO_CPIC);
	if (cpic_sock < 0) {
		*return_code = CM_CALL_NOT_SUPPORTED;
		return;
	}
	args->conversation_id = conversation_id;
	args->opcode = opcode;
	args->return_code = return_code;
	ioctl(cpic_sock, SIOCCPICC, args);
}
        ...
        CM_RETURN_CODE CM_PTR return_code)
{
	cpic_args *args;
	cargo1(args, NULL);
	cpicall(conversation_id, CM_CMACCI, args, return_code);
	free(args);
}
        ...
        CM_RETURN_CODE CM_PTR return_code)
{
	cpic_args *args;
	cargo1(args, NULL);
	cpicall(conversation_id, CM_CMALLC, args, return_code);
	free(args);
}
        ...
        CM_RETURN_CODE CM_PTR return_code)
{
	cpic_args *args;
	cargo1(args, NULL);
	cpicall(conversation_id, CM_CMCANC, args, return_code);
	free(args);
}
        ...
        CM_RETURN_CODE CM_PTR return_code)
{
	cpic_args *args;
	cargo1(args, NULL);
	cpicall(conversation_id, CM_CMCFMD, args, return_code);
	free(args);
}
        ...
        CM_RETURN_CODE CM_PTR return_code)
{
	cpic_args *args;
	cargo1(args, NULL);
	cpicall(conversation_id, CM_CMDEAL, args, return_code);
	free(args);
}
        ...
        CM_RETURN_CODE CM_PTR return_code)
{
	cpic_args *args;
	cargo1(args, NULL);
	cpicall(conversation_id, CM_CMDFDE, args, return_code);
	free(args);
}
        ...
        CM_RETURN_CODE CM_PTR return_code)
{
	cpic_args *args;
	cargo1(args, NULL);
	cpicall(conversation_id, CM_CMFLUS, args, return_code);
	free(args);
}
        ...
        CM_RETURN_CODE CM_PTR return_code)
{
	cpic_args *args;
	cargo1(args, NULL);
	cpicall(conversation_id, CM_CMINCL, args, return_code);
	free(args);
}
        ...
        CM_RETURN_CODE CM_PTR return_code)
{
	cpic_args *args;
	cargo1(args, NULL);
	cpicall(conversation_id, CM_CMINIC, args, return_code);
	free(args);
}
        ...
        CM_RETURN_CODE CM_PTR return_code)
{
	cpic_args *args;
	cargo1(args, NULL);
	cpicall(conversation_id, CM_CMPREP, args, return_code);
	free(args);
}
        ...
        CM_RETURN_CODE CM_PTR return_code)
{
	cpic_args *args;
	cargo1(args, NULL);
	cpicall(conversation_id, CM_CMPTR, args, return_code);
	free(args);
}
        ...
        CM_RETURN_CODE CM_PTR return_code)
{
	cpic_args *args;
	cargo1(args, NULL);
	cpicall(conversation_id, CM_CMRTS, args, return_code);
	free(args);
}
